...
all_stopwords = list(STOPWORDS.union([
    # Words with contractions (don't, we'll)
    'don', 't', 's', 'll', 're', 've', 'm', 'd', 'didn', 'doesn', 'isn', 'aren', 'wasn', 'weren', 'hasn', 'haven', 'hadn', 'shouldn', 'wouldn', 'coudn',
    ...
    'one', 'two', 'another', 'someone', 'something', 'things', 'anything', 'everything', 'away'

    # Verben
    'want', 'need', 'know', 'like', 'return', 'think', 'meet', 'take', 'come', 'take', 'going', 'leave', 'do', 'live', 'go', 'find',
    'wants', 'needs', 'knows', 'likes', 'returns', 'thinks', 'meets', 'takes', 'comes', 'takes', 'going', 'leaves', 'does', 'lives', 'finds',
